...
create sequence if not exists user_role_seq increment by 10 minvalue 1 maxvalue 999999999999999999 cache 10 no cycle;
...
create sequence if not exists room_seq increment by 10 minvalue 1 maxvalue 999999999999999999 cache 10 no cycle;

create table if not exists room_status(
    id                  numeric(19, 0) primary key,
    name                varchar(64) not null unique
);
create sequence if not exists room_status_seq increment by 10 minvalue 1 maxvalue 999999999999999999 cache 10 no cycle;
...
create sequence if not exists room_images_seq increment by 10 minvalue 1 maxvalue 999999999999999999 cache 10 no cycle;